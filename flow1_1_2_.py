...
def handle_flow_1_subflow_1_2_1(numero, name):
    data = {
    ...
    generic_reply(data)
    update_user_state(numero, subFlow4 = 1, func = str(inspect.currentframe().f_code.co_name)) # Retirar 0 cuando tengamos la lógica completa de BENEFICIOS
